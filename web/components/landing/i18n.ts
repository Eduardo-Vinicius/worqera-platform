...
export const translations = {
  pt: {
    ...
    clients: {
      ...
      title: "Empresas que confiam na Worqera",
      subtitle: "Negócios de todos os tamanhos já transformaram sua gestão de pedidos com a gente.",
      companies: [
        {
    ...
    // Pricing
    pricing: {
      title: "Soluções adaptáveis ao seu momento",
      subtitle: "Escolha o plano que se encaixa perfeitamente na sua operação.",
      setup: "Implantação",
      monthly: "/mês",
      plans: [
        {
          ...
          price: "A negociar",
          setup: "",
          description: "Para começar de forma estruturada",
          features: [
        ...
        },
        {
          ...
          price: "A negociar",
          setup: "",
          description: "Para operações de alto volume e múltiplas unidades",
          features: [
            "Tudo do Pro, mais:",
            "Pedidos ilimitados",
      ...
      custom: "Cada negócio tem suas particularidades. Entre em contato para uma proposta personalizada.",
      guarantee: "🛡️ Garantia de 30 dias: Não gostou? Devolvemos seu dinheiro.",
      roi: "💰 ROI comprovado: Clientes economizam em média 5 horas/semana.",
    },
    // FAQ
    faq: {
  ...
  en: {
    ...
    clients: {
      badge: "Proven Trust",
      title: "Companies that trust Worqera",
      subtitle: "Businesses of all sizes have already transformed their order management with us.",
      companies: [
        {
          name: "A Casa do Tênis",
    ...
    // Pricing
    pricing: {
      title: "Solutions adaptable to your moment",
      subtitle: "Choose the plan that fits your operation perfectly.",
      setup: "Setup",
      monthly: "/month",
      plans: [
        {
          ...
          price: "To discuss",
          setup: "",
          description: "To start in a structured way",
          features: [
            "Custom Kanban",
            "1 active user",
        ...
        },
        {
          ...
          price: "To discuss",
          setup: "",
          description: "Most chosen by growing companies",
          features: [
            "Advanced flexible Kanban",
            "Unlimited users",
            "Unlimited orders",
            ...
            "Implementation in up to 1 week",
          ],
        ...
        },
        {
          ...
          price: "To discuss",
          setup: "",
          description: "For high-volume operations and multiple locations",
          features: [
      ...
      custom: "Every business has its particularities. Contact us for a personalized proposal.",
      guarantee: "🛡️ 30-day guarantee: Not satisfied? We refund your money.",
      roi: "💰 Proven ROI: Clients save an average of 5 hours/week.",
    },
    // FAQ
    faq: {
